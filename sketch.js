...
function draw() {
  ...
  noStroke();
  fill("white");
  text("By Alexander Toms Digaul", 200,530);

  textSize(25);
  noStroke();
  fill("yellow");
  text("Instagram : @ alexander_toms_digaul", 200,560);
  ...
  noStroke();
  fill("purple");
  text("For business enquiry contact : alexander.toms.digaul@gmail.com",200,590);  
